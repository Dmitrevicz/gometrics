...
func TestParseFromFile(t *testing.T) {
	targetConfig := Config{
		...
		DatabaseDSN:   "some-test-dsn",
		CryptoKey:     "./test-crypto-key.pem",
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, targetConfig.ServerAddress, tt.args.cfg.ServerAddress, msg, "ServerAddress")
			assert.Equal(t, targetConfig.DatabaseDSN, tt.args.cfg.DatabaseDSN, msg, "DatabaseDSN")
